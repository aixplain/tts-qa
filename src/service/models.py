...
class Sample(Base):  # type: ignore
    ...
    deliverable = Column(String(50), unique=False, nullable=True)
    ...
    local_custom_trimmed_path = Column(String(120), unique=False, nullable=True)
    ...
    trim_custom_start = Column(Float, unique=False, nullable=True)
    trim_custom_end = Column(Float, unique=False, nullable=True)
