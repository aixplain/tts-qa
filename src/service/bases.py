...
class InputAnnotationModel(BaseModel):
    ...
    incorrectProsody: bool = Field(..., description="The sample has incorrect prosody")
    inconsistentTextAudio: bool = Field(..., description="The sample has inconsistent text and audio")
    incorrectTrancuation: bool = Field(..., description="The sample has incorrect trancuation")
    soundArtifacts: bool = Field(..., description="The sample has sound artifacts")
